...
%
% Set the main stylesheet for most part of the thesis.  See class 'memoir'
% and LaTeX documentations for details.  Modify as appropriate.
% ------------------------------------------------------------------------
...
% to inside round brackets with optional pre-text.
% E.g. ``\beqref[see ]{eq:equation}`` may show '(see eq.~5)'
% partly hyperlinked.
