...
%
% Set the styles of front matter elements.
% ------------------------------------------------------------------------
...
\newcommand{\quickwordcount}[1]{%
    ...
    This thesis has an estimated word count of
    {\ttfamily\input{wordcount.sum}\unskip}
    for the abstract, main matter and appendices.
    Captions and footnotes are included in this count.
}
