...
\begin{figure}
    \centering
    \includegraphics[width=8.5cm,trim={0 4mm 0 0},clip]{Construction}
...
\kant*[8][1-2]Add a quote.\footnote{\quotestamp\qtl{A smart quote.}}
...
\paragraph{Gaussian random fields.} \kant[10][1-2]
    ...
    \end{equation}
where \notn{vartheta} is the \term{spherical polar angle}, and the normalisation constant is given by
    \begin{equation}
