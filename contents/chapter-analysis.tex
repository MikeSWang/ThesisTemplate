...
This weight is explicitly dependent on the wavenumber~\(k\) of the band power spectrum one attempts to estimate; in practice, it suffices to set it to a constant value typical of the power spectrum in the range of scales of interest, \eg\ \(\bar{P} = \groupfour{10000}\,\si{\per\cubic\mega\parsec}\) set in the \gls{BOSS} Data Release 12 analysis.
    ...
    \end{equation}
\Rcite{Wang2020b} argues that\textellipsis\ The coefficients~\(A^{\ell_1}_{\ell L}\) can be found from the identity
    \begin{equation}
...
\begin{figure}
    ...
    \floatbox[{%
        ...
        \includegraphics[height=0.9\normalwd,trim={0 3mm 0 1mm},clip]{Construction}
    }{{%
        \captionsetup{justification=raggedright}
        \caption[Best-fitting models. {[Reprinted under the Licence]}]{Best-fitting models. Figure taken from Fig.~1 in \citetalias{Wang2020a}.}
        \label{fig:luminosity function}
    }}
\end{figure}
}
Or perhaps
