...
%
% Set up package configurations.  Tweak various settings to achieve
% desired typesetting outcomes.  See individual package documentation
...
% Set numbering for continuously labelled figures.
...
% Determine whether or not to add hyperlinks for certain categories.
\glssetcategoryattribute{topic}{nohyper}{true}
\glssetcategoryattribute{notation}{nohyper}{true}

% Use only short form for certain acronyms, and only short form in small
% caps for code names.
