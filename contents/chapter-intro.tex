...
\begin{figure}
    ...
    \caption[Under Construction. {[Licensed under \nolinkurl{invalid/licence/example}]}]{\qts{Under Construction}. Figure taken from a fairytale (credit: Fairy~McTale \etal).}
...
\paragraph{Gaussian random fields.} \kant*[8][1-2]
    ...
    \end{equation}
where the \term{normalisation constant} is
    \begin{equation}
...
may be replaced by its volume average,
    ...
    \end{equation}
The shot noise power will add to the underlying clustering power spectrum \bref[see ][ for an illustration of Poisson sampling]{fig:construction}.
    \begin{align}
